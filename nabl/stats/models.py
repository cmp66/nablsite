...
class Gameresults(models.Model):
    ...
    scheduleid = models.ForeignKey(Schedules, models.CASCADE, db_column='scheduleid', default=0)
...
class GameresultsAdmin(admin.ModelAdmin):
    fields = ['scheduleid', 'gamenumber', 'homepitcher', 'visitpitcher', 'homeruns', 'visitruns', 'comment']
    list_display = ('scheduleid', 'gamenumber', 'homepitcher', 'visitpitcher', 'homeruns', 'visitruns')
    search_fields = ['scheduleid', 'gamenumber', 'homepitcher', 'visitpitcher', 'homeruns', 'visitruns']
...
class SeriesStatRecords(models.Model):
    ...
    reportingteamid = models.ForeignKey(Teams, models.CASCADE, db_column='reportingteamid', related_name='reportteam', default=0)
    statsteamid = models.ForeignKey(Teams, models.CASCADE, db_column='statsteamid', related_name='statsteam', default=0)
    playerid = models.ForeignKey(Players, models.CASCADE, db_column='playerid', default=0)
...
class Teamresults(models.Model):
    id = models.AutoField(primary_key=True)
    teamid = models.ForeignKey(Teams, models.CASCADE, db_column='teamid', default=0)
    divisionid = models.ForeignKey(Divisions, models.CASCADE, db_column='divisionid', default=0)
    year = models.IntegerField()
    leagueid = models.ForeignKey(Leagues, models.CASCADE, db_column='leagueid', default=0)
