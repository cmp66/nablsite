...
class Draftpicks(models.Model):
    ...
    slotteam = models.ForeignKey(Teams, models.CASCADE, db_column='slotteam', related_name='slotteam', blank=True, null=True)
    ownerteam = models.ForeignKey(Teams, models.CASCADE, db_column='ownerteam', related_name='ownerteam', blank=True, null=True)
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['draftyear', 'slotteam', 'round'], name='unique_draftyear_slotteam'),
        ]
        indexes = [
            models.Index(fields=['draftyear', 'slotteam', 'ownerteam'], name='draftpicks_draftyear_teams_idx'),
