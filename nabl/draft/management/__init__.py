...
class DraftManager():
    ...
    def migration_draft_picks(self, newseason, oldseason):
        ...
        for old_draft_pick in old_draft_picks:
            existing_pick = Draftpicks.objects.filter(draftyear=newseason, slotteam=old_draft_pick.slotteam, ownerteam=old_draft_pick.slotteam, round=old_draft_pick.round)
